...
namespace followMe.Services
{
    ...
    {
        public void NavigateToGame(string username, string sessionID, bool isDesign, bool isRegistering)
        {
            ...
            context.Clients.All.returnGameNavigation(world.fullName, world.worldName, username, sessionID, isDesign, isRegistering);
        }
    }
}