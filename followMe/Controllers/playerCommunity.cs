...
namespace followMe.Controllers
{
    ...
    public class playerCommunityController : Controller
    {
        ...
        public JsonResult checkFriendStatus(string me, string them)
        {
            ...
            return Json(isFriend, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult getMessages(string forUser, string to)
        {
            ...
            return Json(newMessagesFrom.OrderBy(m => m.when), JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult getOtherPlayers(string username)
        {
            ...
            return Json(otherPlayers, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult getOtherPlayer(int rank, string whoInPage, string forWho)
        {
            ...
            return Json(otherPlayer, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(comm.getMyLevels(username, onlyDone), JsonRequestBehavior.AllowGet);
        }
    }
}