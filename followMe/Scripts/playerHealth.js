$(function () {
    var memServer = $.connection.userMethods;
    memServer.client.updateMemberLives = function (object, level, username) {
    ...
    followMe.updatehealth = function (name, health, automated, otherObj) {
        ...
        if (object.lives <= 0 && otherObj == undefined) {
            ...
            $(".checkpoint").each(function () {
                ...
                memServer.server.gameOver(localStorage.getItem("username"), object.lives, object.maxHealth)
