$(function () {
    $.connection.hub.start("~/signalr").done(function () {
        followMe.setPrimaryHealth = function (personObj) {
            followMe.multiplayer.server.showPrimaryHealth(personObj.health, personObj.username, personObj.lives);
        }
        ...
        followMe.shootOnline = function (shotID, down, moveEachTime, mouseX, mouseY, behind, weaponClass, username, shotObj) {
            if (followMe.players[1].online) {
                followMe.multiplayer.server.fireOnlineBullet(shotID, down, moveEachTime, mouseX, mouseY, behind, weaponClass, username, localStorage.getItem("currentCaveName"), shotObj)
    ...
    followMe.multiplayer = $.connection.multiplayerServices;
    ...
    followMe.multiplayer.client.showLocalStatsFromShot = function (username, health, lives, died)
    {
