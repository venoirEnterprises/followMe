$(function () {
    ...
    followMe.communityServices = $.connection.communityServices;
    ...
    followMe.communityServices.client.addLevelProgressObject = function (progressObject) {
    ...
    followMe.communityServices.client.DisplayFullProgress = function (rankName, fullname,
    ...
    followMe.communityServices.client.showNotificationCount = function (howMany, forWho, type, information) {
    ...
    followMe.communityServices.client.showOtherPlayerMessage = function (to, from, message) {
    ...
    followMe.communityServices.client.givePartnerCheckpoint = function (username, helpRequest, checkpoint) {
    ...
    followMe.communityServices.client.hurtPartnerEnemy = function (username, helpRequest, hurtExternal, enemyID) {
    ...
    followMe.communityServices.client.thisPlayerPresenceRemoved = function (username, helpRequest) {
