$("#game").on('pagebeforeshow ready', function () {
    ...
    followMe.players = [];
    followMe.levelServicesDefined.client.Startpoint = function (
    ...
    followMe.userServicesDefined.client.getWeapon = function (username, weaponDefinition, online, community) {
        //if (username != localStorage.getItem("username"))
        //{
    ...
    $("#weaponID").val(1)
    followMe.userServicesDefined.client.getWeapons = function (username, theWeapon) {
        if (username == localStorage.getItem("username")) {
