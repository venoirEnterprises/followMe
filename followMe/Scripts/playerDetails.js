$(document).ready(function () {
        ...
        followMe.userServicesDefined.client.userMethods = function (existingName, newName, method, username) {
        ...
        followMe.userServicesDefined.client.getXPAllocationArray = function (username, allocationArray) {
            if (username == localStorage.getItem("username")) {
        ...
        followMe.userServicesDefined.client.playerNewXPAndRank = function (username, xp, rank, max, stats) {
